...
/*	function mostraLlibresAlumne ($conexion, $nia){
	...
	function puntuacioLotsTutoria($conexion,$tutoria){
		$sentencia = "select concat(A.nombre, ' ', A.apellido1,' ', A.apellido2), E.id_lote, sum(E.puntos) as puntos, L.repartit, L.folres, L.valoracioglobal from Ejemplar E, Alumno A, Lote L where E.id_lote = A.id_lote and L.id_lote=E.id_lote and A.id_tutoria=\"";
